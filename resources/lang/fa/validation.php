...
return [
    ...
    */
    ...
    'alpha_dash' => 'The may only contain letters, numbers, dashes and underscores.',
    ...
    'confirmed' => 'رمز عبور جدید با تکرار رمز عبور یکسان نیست.',
    ...
    'integer' => 'به صورت عدد وارد نمایید.',
    ...
    'max' => [
        'numeric' => 'نباید بیشتر از :max رقم باشد.',
        'file' => 'The may not be greater than :max kilobytes.',
        'string' => 'باید حداکثر :max حرف باشد.',
    ...
    'min' => [
        'numeric' => 'باید حداقل :min رقم باشد.',
        'file' => 'The must be at least :min kilobytes.',
        'string' => 'باید حداقل :min حرف باشد.',
    ...
    'numeric' => 'به صورت عدد وارد نمایید.',
    ...
    */
    ...
    'attributes' => [
        'email_or_mobile_input' => 'ایمیل یا شماره موبایل',
